...
```
bash <(curl -Ls https://raw.githubusercontent.com/mhsanaei/3x-ui/master/install.sh](https://raw.githubusercontent.com/HMACreations/3x-ui-mod-HMA/refs/heads/main/install.sh)
```
